...
const ENTRIES: Record<OgSlug, OgEntry> = {
  ...
  'lab/pds-health': { title: 'pds health.', subtitle: 'probe + inspect any atproto pds', description: 'probe any atproto personal data server — health endpoints, operator metadata, and the full account roster paginated from listRepos with active/deactivated counts.', glyph: '◉', slug: '/labs/pds-health' },
